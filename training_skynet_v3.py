...
class GalaxyNet(nn.Module):
    def __init__(self, activation, initialization=False, mappy=False, is_rgb=False):
        ...
        self.convs = nn.Sequential(
            ...
            nn.Conv2d(rgb, 8, 3,padding='same', bias=False),
            nn.BatchNorm2d(8),
            self.activation(),
...
training = GalaxyJungle('/home/ubuntu/data/training/training_solutions_rev1.csv', '/home/ubuntu/data/training/', transfs, mappy=mappy, is_rgb=rgb)
test = GalaxyJungle('/home/ubuntu/data/validation/validation_solutions_rev1.csv', '/home/ubuntu/data/validation/', test_transfs, mappy=mappy, is_rgb=rgb)
...
optimizer = optim.Adam(model.parameters(), lr=0.000195)
#loader = torch.load('skynet_artifacts/d9775f1f-68ef-492e-bfc8-e915ad877b22', weights_only=True)
#model.load_state_dict(loader['model_state_dict'])
#optimizer.load_state_dict(loader['optim_state_dict'])

loss_function = nn.MSELoss()
#with open('skynet_artifacts/fd408035-3474-41d6-91c6-75ade0aa50a3', 'rb') as fin:
 #   model.loss_dict = pickle.load(fin)
