...
def mappy(tensor,datafr=False):
    ...
    class4_2 = torch.where(class4_2.sum(keepdim=True) != 0, 
                           class4_2 / class4_2.sum(keepdim=True), 
                           class4_2)
    class5_4 = torch.where(class5_4.sum(keepdim=True) != 0, 
                           class5_4 / class5_4.sum(keepdim=True), 
                           class5_4)
