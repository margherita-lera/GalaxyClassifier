...
Oggi io e marghe abbiamo abbozzato uno scheletro della CNN. Abbiamo seguito un video di un tipo che la faceva con pytorch a questo ![https://www.youtube.com/watch?v=CtzfbUwrYGI]{link}.
...
Dopodicè abbiamo fatto un ciclo per le epoche.

Bisogna wrappare il test set.

Da capire se le label vanno bene così, la NN le comprende?? we'll see. Margherita propone di ricostrure la probabilità di ogni ramo dell'albero, in modo da avere classi con delle probabilità indipendenti.
